...
declare function requestHandler(resolve: any, reject: any, path: any, token: any, options: any): any;
declare function validateOptions(token: any, schema: any, options: any): Promise<void>;
...
declare function generateNoSchemaHandler(path: any): (token: any, options: any) => Promise<unknown>;
