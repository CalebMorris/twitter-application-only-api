...
exports.subscriptions = exports.optionsSchema = void 0;
...
function subscriptions(callHandler, options) {
    return callHandler.callTwitterApiWithSchema('lists/subscriptions', options, exports.optionsSchema);
}
