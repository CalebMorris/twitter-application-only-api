...
var omembed = function(token, options) {
  return new Promise(function(resolve, reject) {
    ...
    var requestCallback = function(err, res, body) {
      ...
      if (res.statusCode !== 200) {
        return reject(new Error('Problem retrieving omembed: ' + JSON.stringify(res)));
      }
    ...
    Joi.validate(options, optionsSchema, function(err, value) {
      ...
      var requestOptions = {
        url     : 'https://api.twitter.com/1.1/statuses/omembed.' + format +
